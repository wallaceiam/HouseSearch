...
import { ofstedController, ofstedValidation } from '../../modules/ofsted';

const router: Router = express.Router();

router.route('/').get(validate(ofstedValidation.getSummaries), ofstedController.getSummaries);

router.route('/localAuthorities').get(ofstedController.getLocalAuthorities);
