...
<nav className="bg-gray-50">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="relative flex h-16 items-center justify-between border-b border-gray-200">
        <div className="flex items-center">
          ...
          <div className="hidden lg:ml-10 lg:block">
            <div className="flex space-x-4">
              ...
              <a href="#" className="bg-gray-100 px-3 py-2 rounded-md text-sm font-medium text-gray-900" aria-current="page">Dashboard</a>
        ...
        <div className="flex lg:hidden">
          {/* <!-- Mobile menu button --> */}
          <button type="button" className="inline-flex items-center justify-center rounded-md bg-gray-50 p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-50" aria-controls="mobile-menu" aria-expanded="false">
    ...
    <div className="border-b border-gray-200 bg-gray-50 lg:hidden" id="mobile-menu">
      <div className="space-y-1 px-2 pt-2 pb-3">
        ...
        <a href="#" className="bg-gray-100 block px-3 py-2 rounded-md font-medium text-gray-900" aria-current="page">Dashboard</a>
